            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="/Your-Lists" key="Your-Lists" class="waves-effect">
                        <i class="bx bx-file"></i>
                        <span><?php echo app('translator')->get('translation.Your-Lists'); ?></span>
                    </a>
                </li>
...
<!-- Left Sidebar End -->
<?php /**PATH F:\Giacometti\Skote_Html_Laravel_v4.2.1\Laravel\Server-Backup\New-Branch-Work-6-10-2024\working-one\22-7-2024-latest-one\sales-appcontratti\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>